        ...
        <table class="table-auto mt-12 md:mt-32 w-full">
          ...
          <tbody>
            <?php
                ...
                $sql = "SELECT * FROM posiciones ORDER BY victorias DESC, derrotas ASC";
                $result = $conexion->query($sql);
        
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>
                                <td class='border border-gray-300 p-2'>" . $row["equipo"]. "</td>
                                <td class='border border-gray-300 p-2'>" . $row["victorias"]. "</td>
                                <td class='border border-gray-300 p-2'>" . $row["derrotas"]. "</td>
                            </tr>";
                    }
                } else {
